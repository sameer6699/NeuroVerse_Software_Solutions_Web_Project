  ...
  try {
    await fetch(import.meta.env.VITE_MONITORING_URL, {
      ...
      body: JSON.stringify({
        ...
        projectSemanticIdentifier: import.meta.env.VITE_APP_ID,
      }),
    });
  } catch (error) {
  ...
  return (
    ...
    >
      <DialogContent className="bg-red-700 text-white max-w-4xl">
        ...
        A runtime error occurred. Open the app editor to automatically debug the
        error.
        <div className="mt-4">
          <Collapsible>
            <CollapsibleTrigger>
        ...
        <DialogFooter>
          <a
            href={`https://neuroglass.ai/project/${import.meta.env.VITE_APP_ID}`}
            target="_blank"
          >
            <Button>
