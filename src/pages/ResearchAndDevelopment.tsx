...
export default function ResearchAndDevelopment() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      {/* Research Institute Banner Section */}
          ...
          <div className="md:col-span-3 bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 p-8 md:p-10 lg:p-12 flex flex-col justify-center">
            ...
            >
              ...
              <p className="text-base md:text-lg lg:text-xl text-white/90 leading-relaxed max-w-2xl">
                Our number one ranked think-tank. Leading the conversation on research and development initiatives through comprehensive research, thought leadership, and strategic partnerships. We bring together leading researchers, industry experts, and innovators to address global challenges and drive sustainable innovation.
              </p>
