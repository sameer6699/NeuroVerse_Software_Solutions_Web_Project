...
import { Leaf, ArrowRight, Wind, Sun, TrendingUp, CheckCircle2, Linkedin, ChevronLeft, ChevronRight, Target, Zap, Recycle, Droplets, BarChart3, Sparkles } from "lucide-react";
import { images } from "@/assets";
import { useRef } from "react";
import { Link } from "react-router";

/**
 * Sustainability & Green Technology Page Component
 * 
 * This page displays sustainability and green technology-specific solutions.
 * The Navbar and Footer are automatically included via the global Layout component.
 */
export default function SustainabilityGreenTechnology() {
  ...
  const sustainabilitySolutions = [
    {
      ...
      description: "Comprehensive renewable energy solutions including solar, wind, and hydroelectric power systems that reduce carbon footprint and energy costs.",
      features: ["Solar Energy Systems", "Wind Power", "Energy Storage", "Grid Integration"]
    },
    {
      icon: Recycle,
      title: "Waste Management & Recycling",
      description: "Advanced waste management and recycling solutions that minimize environmental impact and promote circular economy principles.",
      features: ["Waste Reduction", "Recycling Programs", "Composting Systems", "Circular Economy"]
    },
    {
      icon: Droplets,
      title: "Water Conservation & Management",
      description: "Intelligent water management solutions that optimize water usage, reduce waste, and ensure sustainable water resource management.",
      features: ["Water Monitoring", "Leak Detection", "Water Recycling", "Conservation Systems"]
    },
    {
      icon: BarChart3,
      title: "Carbon Footprint Tracking",
      description: "Comprehensive carbon footprint tracking and reduction solutions that help organizations measure, monitor, and minimize their environmental impact.",
      features: ["Emissions Tracking", "Carbon Accounting", "Sustainability Reporting", "Offset Programs"]
    },
    {
      icon: Sparkles,
      title: "Green Building Solutions",
      description: "Sustainable building solutions that optimize energy efficiency, reduce environmental impact, and create healthier indoor environments.",
      features: ["Energy Efficiency", "LEED Certification", "Smart Building Systems", "Sustainable Materials"]
    },
    {
      icon: Sun,
      title: "Sustainable Technology Integration",
      description: "Integration of sustainable technologies across operations to reduce environmental impact and achieve sustainability goals.",
      features: ["Technology Assessment", "Green IT Solutions", "Energy Management", "Sustainability Planning"]
    },
  ];
  ...
  const benefits = [
    {
      ...
      description: "Comprehensive sustainability solutions significantly reduce carbon footprint, waste generation, and resource consumption."
    },
    {
      icon: TrendingUp,
      title: "Cost Savings",
      description: "Energy-efficient solutions and waste reduction initiatives lower operational costs and improve long-term financial performance."
    },
    {
      icon: CheckCircle2,
      title: "Regulatory Compliance",
      description: "Ensure compliance with environmental regulations and sustainability standards while building a positive brand reputation."
    },
    {
      icon: Target,
      title: "Sustainable Growth",
      description: "Sustainable practices enable long-term growth while protecting the environment and meeting stakeholder expectations."
    },
  ];
  ...
  const useCases = [
    {
      ...
      description: "Comprehensive renewable energy platform with solar, wind, and energy storage solutions for sustainable energy generation and carbon footprint reduction.",
      technologies: ["Solar Energy", "Wind Power", "Energy Storage", "Smart Grid"]
    },
    {
      title: "Carbon Management & Reporting",
      description: "Advanced carbon management solution with emissions tracking, carbon accounting, and sustainability reporting for comprehensive environmental impact management.",
      technologies: ["Carbon Tracking", "Emissions Monitoring", "Sustainability Reporting", "Analytics"]
    },
    {
      title: "Smart Water Management",
      description: "Intelligent water management system with real-time monitoring, leak detection, and conservation optimization for sustainable water resource management.",
      technologies: ["IoT Sensors", "Water Monitoring", "Leak Detection", "Conservation Systems"]
    },
    {
      title: "Green Building & Energy Efficiency",
      description: "Sustainable building solution with energy efficiency optimization, smart building systems, and LEED certification support for green building transformation.",
      technologies: ["Energy Management", "Smart Buildings", "LEED Certification", "Building Automation"]
    },
  ];
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      {/* Sustainability & Green Technology Card - Positioned outside hero section, extending from hero */}
          ...
          <div className="flex justify-end">
            ...
            >
              ...
              >
                ...
                {/* Sustainability & Green Technology Text - Centered in the box */}
                <motion.h1
      ...
      {/* Sustainability & Green Technology-Specific Solutions Section */}
            ...
            >
              <div className="space-y-4">
                ...
                <p className="text-base md:text-lg lg:text-xl text-gray-700 leading-relaxed max-w-4xl">
                  Discover how NeuroVerse delivers comprehensive sustainability and green technology solutions that reduce environmental impact, optimize resource usage, and enable sustainable business practices for a greener future.
                </p>
                <div className="pt-4">
      ...
      {/* Sustainability Case Study Banner/Carousel Section - Full Width */}
      <section className="relative bg-white py-8 md:py-12 w-full">
        ...
        >
          {/* Background Image - Full Width with Sustainability Theme */}
          <div 
              ...
              <div className="flex items-center justify-start">
                ...
                >
                  ...
                  <h3 className="text-2xl md:text-3xl lg:text-4xl font-heading font-bold text-gray-900 mb-4 md:mb-6 leading-tight group-hover:text-blue-900 transition-colors duration-300">
                    Build a sustainable future with green technology solutions
                  </h3>
                  
                  {/* Body Text */}
                  <p className="text-base md:text-lg text-gray-700 leading-relaxed mb-6 md:mb-8">
                    NeuroVerse empowers organizations to achieve sustainability goals through renewable energy solutions, carbon management, waste reduction, and green technology integration. Our expertise enables environmental impact reduction, cost savings, and sustainable growth.
                  </p>
      ...
      <section className="relative bg-white py-12 md:py-16 px-4">
        <div className="max-w-7xl mx-auto max-w-5k-content">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            {/* Card 1: Renewable Energy Solutions */}
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              ...
              <div className="p-6 md:p-8">
                ...
                <div className="space-y-3 text-gray-700 leading-relaxed">
                  <p className="text-sm md:text-base">
                    Comprehensive renewable energy solutions including solar, wind, and hydroelectric power systems that reduce carbon footprint and energy costs. We help organizations transition to clean energy.
                  </p>
                  <p className="text-sm md:text-base">
                    Our solutions include solar energy systems, wind power, energy storage, and grid integration for comprehensive renewable energy adoption.
                  </p>
                </div>
              </div>
            </motion.div>

            {/* Card 2: Carbon Footprint Tracking */}
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            >
              ...
              <div className="p-6 md:p-8">
                ...
                <div className="space-y-3 text-gray-700 leading-relaxed">
                  <p className="text-sm md:text-base">
                    Comprehensive carbon footprint tracking and reduction solutions that help organizations measure, monitor, and minimize their environmental impact. We enable data-driven sustainability decisions.
                  </p>
                  <p className="text-sm md:text-base">
                    Our solutions support emissions tracking, carbon accounting, sustainability reporting, and offset programs for comprehensive carbon management.
                  </p>
                </div>
              </div>
            </motion.div>

            {/* Card 3: Waste Management & Recycling */}
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            >
              ...
              <div className="p-6 md:p-8">
                ...
                <div className="space-y-3 text-gray-700 leading-relaxed">
                  <p className="text-sm md:text-base">
                    Advanced waste management and recycling solutions that minimize environmental impact and promote circular economy principles. The expansion of sustainability initiatives demands comprehensive waste management approaches.
                  </p>
                  <p className="text-sm md:text-base">
                    Waste reduction, recycling programs, and circular economy practices are driving transformation. Organizations implementing comprehensive waste management fastest will lead the next generation of sustainability.
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            <div className="relative w-full h-64 md:h-80 lg:h-96 bg-black overflow-hidden group-hover:scale-105 transition-transform duration-700">
              ...
              <div className="absolute inset-0">
                ...
                <svg className="absolute inset-0 w-full h-full" viewBox="0 0 400 400" preserveAspectRatio="xMidYMid slice">
                  {/* Network lines */}
                  <defs>
                    <linearGradient id="lineGradientBlueSUS" x1="0%" y1="0%" x2="100%" y2="100%">
                  ...
                  {/* Connecting lines */}
                  <line x1="50" y1="80" x2="150" y2="120" stroke="url(#lineGradientBlueSUS)" strokeWidth="1.5" opacity="0.6" />
                  <line x1="150" y1="120" x2="250" y2="100" stroke="url(#lineGradientBlueSUS)" strokeWidth="1.5" opacity="0.6" />
                  <line x1="100" y1="200" x2="200" y2="180" stroke="url(#lineGradientBlueSUS)" strokeWidth="1.5" opacity="0.6" />
                  <line x1="200" y1="180" x2="300" y2="220" stroke="url(#lineGradientBlueSUS)" strokeWidth="1.5" opacity="0.6" />
                  <line x1="80" y1="250" x2="180" y2="280" stroke="url(#lineGradientBlueSUS)" strokeWidth="1.5" opacity="0.6" />
                  <line x1="220" y1="150" x2="320" y2="200" stroke="url(#lineGradientBlueSUS)" strokeWidth="1.5" opacity="0.6" />
                  <line x1="120" y1="300" x2="250" y2="320" stroke="url(#lineGradientBlueSUS)" strokeWidth="1.5" opacity="0.6" />
                  {/* Network nodes (dots) */}
        ...
        <div className="max-w-7xl mx-auto max-w-5k-content">
          ...
          >
            <h2 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-heading font-bold text-gray-900 text-left mb-4">
              Sustainability & Green Technology Use Cases
            </h2>
            <p className="text-lg md:text-xl text-gray-600 max-w-3xl">
              Real-world applications of our sustainability and green technology solutions
            </p>
          </motion.div>
      ...
      <section className="relative bg-white py-8 md:py-12 w-full overflow-hidden">
        ...
        >
            ...
            <div className="md:col-span-3 bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 p-8 md:p-10 lg:p-12 flex flex-col justify-center relative overflow-hidden group hover:from-blue-800 hover:via-blue-700 hover:to-blue-800 transition-all duration-500">
              ...
              >
                ...
                <h2 className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-heading font-bold text-white leading-tight group-hover:text-blue-100 transition-colors duration-300">
                  NeuroVerse Software Solutions recognized as a leader in Sustainability & Green Technology
                </h2>
                ...
                <p className="text-base md:text-lg lg:text-xl text-white/90 leading-relaxed max-w-2xl group-hover:text-white transition-colors duration-300">
                  We have been recognized as a leader in Sustainability & Green Technology Solutions by leading industry analysts for our innovative approaches to renewable energy, carbon management, and environmental sustainability.
                </p>
            ...
            <div className="md:col-span-2 relative h-64 md:h-80 lg:h-96 overflow-hidden">
              <img
                src={images.banners.researchBanner}
                alt="NeuroVerse sustainability leadership recognition"
