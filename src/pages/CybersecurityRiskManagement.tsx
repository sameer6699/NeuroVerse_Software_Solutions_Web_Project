...
export default function CybersecurityRiskManagement() {
  ...
  // Carousel state for Cybersecurity Case Study Banner
  const [currentCarouselIndex, setCurrentCarouselIndex] = useState(0);

  // Carousel items data
  const carouselItems = [
    {
      title: "Protect your digital assets with advanced cybersecurity solutions",
      description: "NeuroVerse empowers organizations to safeguard their digital infrastructure through comprehensive cybersecurity solutions, advanced threat detection, and proactive risk management. Our security expertise enables robust protection, regulatory compliance, and peace of mind in an evolving threat landscape."
    },
    {
      title: "Advanced threat detection and real-time security monitoring",
      description: "Leverage cutting-edge SIEM solutions and threat intelligence platforms to detect, analyze, and respond to security incidents in real-time. Our advanced monitoring systems provide 24/7 protection and rapid incident response capabilities that minimize security risks and business impact."
    },
    {
      title: "Zero Trust security architecture for comprehensive protection",
      description: "Implement a zero trust security model that verifies every user, device, and network connection. Our solutions ensure that no entity is trusted by default, providing enhanced security posture through identity verification, network segmentation, and continuous monitoring."
    },
    {
      title: "Regulatory compliance and risk management solutions",
      description: "Ensure compliance with industry regulations including GDPR, HIPAA, PCI-DSS, and SOC 2. Our comprehensive risk management platforms help identify vulnerabilities, assess risks, and maintain regulatory compliance while protecting your critical digital assets."
    }
  ];
    ...
    <div className="min-h-screen relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            ...
            >
              ...
              <div className="relative w-full h-64 md:h-72 overflow-hidden">
                <img
                  src={images.banners.threatDetectionAndResponse}
            ...
            >
              ...
              <div className="relative w-full h-64 md:h-72 overflow-hidden">
                <img
                  src={images.banners.identityAndAccessManagement}
      ...
      <section className="relative bg-white py-8 md:py-12 w-full overflow-hidden">
        ...
        >
            ...
            <div className="md:col-span-3 bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 p-8 md:p-10 lg:p-12 flex flex-col justify-center min-h-[400px] md:min-h-[500px] lg:min-h-[600px] relative overflow-hidden group hover:from-blue-800 hover:via-blue-700 hover:to-blue-800 transition-all duration-500">
              {/* Animated background pattern */}
              <div className="absolute inset-0 opacity-10">
                <div className="absolute top-0 right-0 w-96 h-96 bg-blue-400 rounded-full blur-3xl transform translate-x-1/2 -translate-y-1/2 group-hover:scale-150 transition-transform duration-1000"></div>
                <div className="absolute bottom-0 left-0 w-72 h-72 bg-blue-500 rounded-full blur-2xl transform -translate-x-1/2 translate-y-1/2 group-hover:scale-125 transition-transform duration-1000"></div>
