...
export const bannerImages = {
  ...
  erpCardImg: new URL('./banner-Images/erp-card-img.png', import.meta.url).href,
  erpBannerCardImg: new URL('./banner-Images/ERP-banner-card-img.png', import.meta.url).href,
  financialManagementBgImg: new URL('./banner-Images/financial-management-bg-img.png', import.meta.url).href,
  financialPlanningCardImg: new URL('./banner-Images/Financial-planning-card-img.png', import.meta.url).href,
  supplyChainManagement: new URL('./banner-Images/supplychain-management.png', import.meta.url).href,
  ...
  ourStoryBannerImg: new URL('./banner-Images/our-story-banner-img.jpg', import.meta.url).href,
  ourStoryBannerImgSmallCard: new URL('./banner-Images/our-story-banner-img-small-card.jpg', import.meta.url).href,
  lifeAtBanner: new URL('./banner-Images/life-at-banner.jpg', import.meta.url).href,
  csrBannerImg: new URL('./banner-Images/CSR-banner-img.jpg', import.meta.url).href,
  latestNewsBannerImg: new URL('./banner-Images/latest-news-banner-img.jpg', import.meta.url).href,
  escBannerImg: new URL('./banner-Images/esc-banner-img.jpg', import.meta.url).href,
  realVisionValuesBannerImg: new URL('./banner-Images/real-vision-values-anner-img.jpg', import.meta.url).href,
  ...
  valuesHeroSectionBg: new URL('./banner-Images/values-herosection-bg.jpg', import.meta.url).href,
  ethicsBannerImage: new URL('./banner-Images/ethics-banner-image.jpg', import.meta.url).href,
  responsibleAiDevelopmentBannerImg: new URL('./banner-Images/responsible-ai-development-banner-img.jpg', import.meta.url).href,
  integrityBannerImg: new URL('./banner-Images/integrity-banner-img.jpg', import.meta.url).href,
  culturalImgBanner: new URL('./banner-Images/cultural-img-banner.jpg', import.meta.url).href,
  objectivesBannerImg: new URL('./banner-Images/objectives-banner-img.jpg', import.meta.url).href,
  humanRightBannerImg: new URL('./banner-Images/human-right-banner-img.jpg', import.meta.url).href,
  speakUpBannerImg: new URL('./banner-Images/speak-up-banner-img.jpg', import.meta.url).href,
  ourEnvironmentBannerImg: new URL('./banner-Images/our-environment-banner-img.jpg', import.meta.url).href,
  corporateSocialResponsibilityBannerImg: new URL('./banner-Images/Corporate social responsibility banner img.jpg', import.meta.url).href,
  ...
  excellenceInExecutionBannerImg: new URL('./banner-Images/excellance-in-execution-banner-img.jpg', import.meta.url).href,
