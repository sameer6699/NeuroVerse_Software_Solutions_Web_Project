...
export const AppToolbar: React.FC = () => {
  ...
  const isDevDeployment =
    ...
    window.location.hostname.endsWith(".app.sh") &&
  ...
  const getProjectName = () => {
    if (typeof window !== "undefined") {
      ...
      // Extract project name from hostname (e.g., "projectname.app.sh")
      const match = hostname.match(/^([^.]+)\.app\.sh$/);
  ...
  const handleGoToProject = () => {
    ...
    window.location.href = `https://neuroglass.ai/project/${projectName}?publish=true`;
  };
